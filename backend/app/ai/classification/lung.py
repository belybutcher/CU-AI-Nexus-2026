"""
Lung X-ray/CT disease classifier — PLACEHOLDER implementation.
...
disease_key = "lung"
labels = ['normal', 'pneumonia', 'tuberculosis', 'covid19', 'lung_cancer']
...
def load_model() -> Any:
    """TODO(AI engineer): load real 'lung' model weights here."""
    global _model_cache
    if _model_cache is None:
        logger.info("Loading placeholder model for disease='%s'", disease_key)
        _model_cache = "placeholder-lung-model"
    return _model_cache


def preprocess(image: Image.Image):
    """TODO(AI engineer): real preprocessing for 'lung' images."""
